                                ...
                                children: [
                                  AnimatedContainer(
                                    child: AnimatedOpacity(
                                      child: Text(
                                          "FACEBOOK",
                                          style: TextStyle(fontSize: MediaQuery.of(context).size.width * 0.006)
                                      ),
                                    ...
                                    padding: selectedFb == false ? EdgeInsets.fromLTRB(0, 0, 0, 0) : EdgeInsets.fromLTRB(0, MediaQuery.of(context).size.width * 0.025, 0, 0),
                                  ...
                                  AnimatedContainer(
                                    child: IconButton(
                                      ...
                                      icon: Icon(FontAwesomeIcons.facebook, size: MediaQuery.of(context).size.width * 0.02,),
                                    ),
                                    duration: Duration(milliseconds: 100),
                                    width: MediaQuery.of(context).size.width * 0.05,
                                    height: MediaQuery.of(context).size.width * 0.05,
                              ...
                              child: Stack(
                                children: [
                                  AnimatedContainer(
                                    ...
                                    curve: Curves.easeOut,
                                    padding: selectedGh == false ? EdgeInsets.fromLTRB(0, 0, 0, 0) : EdgeInsets.fromLTRB(0, MediaQuery.of(context).size.width * 0.040, 0, 0),
                                    alignment: Alignment.center,
                                  ...
                                  AnimatedContainer(
                                    child: IconButton(
                                      ...
                                      icon: Icon(FontAwesomeIcons.github, size: MediaQuery.of(context).size.width * 0.04,),
                                    ),
                                    duration: Duration(milliseconds: 100),
                                    width: MediaQuery.of(context).size.width * 0.05,
                                    height: MediaQuery.of(context).size.width * 0.05,
                              ...
                              child: Stack(
                                children: [
                                  AnimatedContainer(
                                    ...
                                    height: MediaQuery.of(context).size.width * 0.05,
                                    curve: Curves.easeOut,
                                    padding: selectedUniv == false ? EdgeInsets.fromLTRB(0, 0, 0, 0) : EdgeInsets.fromLTRB(0, MediaQuery.of(context).size.width * 0.025, 0, 0),
                                    alignment: Alignment.center,
                                  ...
                                  AnimatedContainer(
                                    child: IconButton(
                                      ...
                                      icon: Icon(FontAwesomeIcons.university, size: MediaQuery.of(context).size.width * 0.02,),
                                    ),
                                    duration: Duration(milliseconds: 100),
                                    width: MediaQuery.of(context).size.width * 0.05,
                                    height: MediaQuery.of(context).size.width * 0.05,
                              ...
                              child: Stack(
                                children: [
                                  AnimatedContainer(
                                    ...
                                    height: MediaQuery.of(context).size.width * 0.06,
                                    curve: Curves.easeOut,
                                    padding: selectedTw == false ? EdgeInsets.fromLTRB(0, 0, 0, 0) : EdgeInsets.fromLTRB(0, MediaQuery.of(context).size.width * 0.040, 0, 0),
                                    alignment: Alignment.center,
                                  ...
                                  AnimatedContainer(
                                    child: IconButton(
                                      ...
                                      icon: Icon(FontAwesomeIcons.twitter, size: MediaQuery.of(context).size.width * 0.04,),
                                    ),
                                    duration: Duration(milliseconds: 100),
                                    width: MediaQuery.of(context).size.width * 0.05,
                                    height: MediaQuery.of(context).size.width * 0.05,
