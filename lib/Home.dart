          ...
          children: [
            Column(
              children: [
                ...
                BounceInDown(child: Container(child: IconButton(onPressed: () async => await canLaunch(fbUrl) ? await launch(fbUrl) : throw 'Could not launch $fbUrl', icon: Icon(FontAwesomeIcons.facebook), iconSize: 64), padding: EdgeInsets.fromLTRB(0, 0, MediaQuery.of(context).size.width/4, 0),), delay: Duration(milliseconds: 1000), animate: _animate,),
                ...
                Padding(padding: EdgeInsets.fromLTRB(0, 40, 0, 0)),
                BounceInDown(child: Container(child: IconButton(onPressed: () async => await canLaunch(ghUrl) ? await launch(ghUrl) : throw 'Could not launch $ghUrl', icon: Icon(FontAwesomeIcons.github), iconSize: 64), padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width/4, 0, 0, 0),), delay: Duration(milliseconds: 1200),)
              ],
            ),
            Column(
              children: [
                ...
                FadeInDown(
                  child: Container(
                    child: Text("Check out my socials and/or repos!", style: GoogleFonts.catamaran(fontSize: 48, fontWeight: FontWeight.bold, color: Colors.white),),
                  ),
                  delay: Duration(milliseconds: 600),
                ),
                FadeInDown(
            ...
            Column(
              children: [
                ...
                Padding(padding: EdgeInsets.fromLTRB(0, MediaQuery.of(context).size.height/3, 0, 0)),
                BounceInDown(child: Container(child: IconButton(onPressed: () async => await canLaunch(asUrl) ? await launch(asUrl) : throw 'Could not launch $asUrl', icon: Icon(FontAwesomeIcons.university), iconSize: 64), padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width/4, 0, 0, 0),), delay: Duration(milliseconds: 1500),),
                Padding(padding: EdgeInsets.fromLTRB(0, 40, 0, 0)),
                ...
                Padding(padding: EdgeInsets.fromLTRB(0, 40, 0, 0)),
                BounceInDown(child: Container(child: IconButton(onPressed: () async => await canLaunch(twUrl) ? await launch(twUrl) : throw 'Could not launch $twUrl', icon: Icon(FontAwesomeIcons.twitter), iconSize: 64,), padding: EdgeInsets.fromLTRB(0, 0, MediaQuery.of(context).size.width/4, 0),), delay: Duration(milliseconds: 1300),)
              ],
            )
          ],
